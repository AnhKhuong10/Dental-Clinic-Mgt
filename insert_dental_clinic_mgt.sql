...
(43, 'MATERIA_IMPORT_UPDATE'),
(44, 'MATERIAL_IMPORT_DETAIL'),
(45, 'MATERIAL_IMPORT_DELETE'),
(46, 'MATERIAL_EXPORT_VIEW'),
(47, 'MATERIAL_EXPORT_CREATE'),
(48, 'MATERIAL_EXPORT_UPDATE'),
(49, 'MATERIAL_EXPORT_DETAIL'),
(50, 'MATERIAL_EXPORT_DELETE');
...
(1, 46), -- ADMIN -> MATERIAL_EXPORT_VIEW
(1, 47), -- ADMIN -> MATERIAL_EXPORT_CREATE
(1, 48), -- ADMIN -> MATERIAL_EXPORT_UPDATE
(1, 49), -- ADMIN -> MATERIAL_EXPORT_DETAIL
(1, 50), -- ADMIN -> MATERIAL_EXPORT_DELETE
...
(2, 46), -- DOCTOR -> MATERIAL_EXPORT_VIEW
(2, 47), -- DOCTOR -> MATERIAL_EXPORT_CREATE
(2, 48), -- DOCTOR -> MATERIAL_EXPORT_UPDATE
(2, 49), -- DOCTOR -> MATERIAL_EXPORT_DETAIL
(2, 50), -- DOCTOR -> MATERIAL_EXPORT_DELETE
...
(3, 46), -- LEADER_NURSE -> MATERIAL_EXPORT_VIEW
(3, 47), -- LEADER_NURSE -> MATERIAL_EXPORT_CREATE
(3, 48), -- LEADER_NURSE -> MATERIAL_EXPORT_UPDATE
(3, 49), -- LEADER_NURSE -> MATERIAL_EXPORT_DETAIL
(3, 50), -- LEADER_NURSE -> MATERIAL_EXPORT_DELETE
...
(4, 46), -- NURSE -> MATERIAL_EXPORT_VIEW
(4, 47), -- NURSE -> MATERIAL_EXPORT_CREATE
(4, 48), -- NURSE -> MATERIAL_EXPORT_UPDATE
(4, 49), -- NURSE -> MATERIAL_EXPORT_DETAIL
(4, 50), -- NURSE -> MATERIAL_EXPORT_DELETE
